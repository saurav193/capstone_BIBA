...
#p1 <- ggdraw() + draw_image("<FILEPATH TO TRAIN PLOT>")
#p2 <- ggdraw() + draw_image("<FILEPATH TO VALID PLOT>")
#plot_grid(p1, p2)
```

``` {r Figure 7, echo=FALSE, message=FALSE, fig.cap="Figure 7. Residual plots of the median-predicting LightGBM model."}

#p3 <- ggdraw() + draw_image("<FILEPATH TO TRAIN PLOT>")
#p4 <- ggdraw() + draw_image("<FILEPATH TO VALID PLOT>")
#plot_grid(p3, p4)
```

``` {r Figure 8, echo=FALSE, message=FALSE, fig.cap="Figure 8. Residual plots of the median-predicting CatBoost model."}

#p5 <- ggdraw() + draw_image("<FILEPATH TO TRAIN PLOT>")
#p6 <- ggdraw() + draw_image("<FILEPATH TO VALID PLOT>")
#plot_grid(p5, p6)
```
